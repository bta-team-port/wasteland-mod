...
public class BiomeProviderWasteland extends BiomeProvider {
	...
	private final double varietyXScale = 0.25;
	private final double varietyZScale = 0.25;
	private final double varietyExponent = 0.3;
	...
	public BiomeProviderWasteland withTemperatureScales(double xScale, double zScale, double exponent, double fuzzPercentage) {
	...
	public BiomeProviderWasteland withHumidityScales(double xScale, double zScale, double exponent, double fuzzPercentage) {
	...
	public BiomeProviderWasteland withFuzzinessScales(double xScale, double zScale, double exponent) {
